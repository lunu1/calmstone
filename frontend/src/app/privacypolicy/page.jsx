        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">Personal Information may include:</h3>
          ...
          <div className="mb-8">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">Specific uses include:</h3>
              <ul className="text-black space-y-1">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-black">Cookies and Tracking Technologies</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          {/* Information Sharing */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-black">Information Sharing and Disclosure</h2>
            <p className="text-black leading-relaxed mb-4">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">We may share information with:</h3>
              <ul className="text-black space-y-1">
          ...
          <div className="mb-8">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">Security measures include:</h3>
              <ul className="text-black space-y-1">
          ...
          <div className="mb-8">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">Retention periods:</h3>
              <ul className="text-black space-y-1">
          ...
          {/* Your Rights */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-black">Your Rights and Choices</h2>
            <p className="text-black leading-relaxed mb-4">
            ...
            <div className="bg-yellow-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-black mb-2">Your rights include:</h3>
              <ul className="text-black space-y-1">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-black">International Data Transfers</h2>
            <p className="text-black leading-relaxed mb-4">
          ...
          {/* Children's Privacy */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-black">Children's Privacy</h2>
            <p className="text-black leading-relaxed mb-4">
